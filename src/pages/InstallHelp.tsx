...
export default function InstallHelp() {
  ...
  return (
    <div className="container max-w-2xl mx-auto p-4 space-y-4">
      ...
      {/* Android Install Prompt (if available) */}
      {isInstallable && deviceType === 'android' && (
        <Card className="border-primary bg-primary/5">
          <CardContent className="py-4">
            <button
              onClick={promptInstall}
              className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 transition-colors"
            >
          ...
          <CollapsibleContent>
            <CardContent className="pt-0 space-y-2">
              ...
              <StepItem 
                number={1} 
                icon={Menu} 
                title={t('install.androidStep1Title')} 
                description={t('install.androidStep1Desc')} 
              />
              <StepItem 
                number={2} 
                icon={Download} 
                title={t('install.androidStep2Title')} 
                description={t('install.androidStep2Desc')} 
              />
              <StepItem 
                number={3} 
                icon={Check} 
                title={t('install.androidStep3Title')} 
                description={t('install.androidStep3Desc')} 
              />
            </CardContent>
          </CollapsibleContent>
        </Card>
